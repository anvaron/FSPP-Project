      ...
      >
        <div class="w-full relative">
          ...
          <p className="absolute top-1 right-0">
            {(product.in_stock >= 1) 
              ?
              <span className="pt-2 pb-1 px-4 bg-teal-400 text-white text-md font-medium rounded-md rounded-br-0  shadow">In Stock</span>
              : 
              <span className="pt-2 pb-1 px-4 bg-red-400 text-white text-md font-semibold rounded-md rounded-md shadow">Out of Stock</span>
            } 
          </p>
        </div>
        <div class="bg-white w-full p-4">
          <p class="text-teal-600 text-sm font-extrabold text-left">
